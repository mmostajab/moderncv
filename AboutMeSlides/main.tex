...
\begin{frame}{VELaSSCo EC Funded Project}
	\begin{itemize}
		\item \textbf{Idea}: Using big data technologies to store and process the simulation data in a distributed manner.
...
%				-- My task is to implement , some of data access queries on HPC side, and streamline computation post processing technique on the HPC side using map-reduce.
%				
%			\end{itemize}		
%	\end{itemize}
%\end{frame}
...
%\begin{frame}{Student Supervision Tasks}
%	\begin{itemize}
%		\item Hi
%	\end{itemize}
%\end{frame}
