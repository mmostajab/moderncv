...
\begin{frame}{Heterogeneous Computing Model (1/7)}
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/MAarch1.PNG}
	\end{figure}
\end{frame}

\begin{frame}{Heterogeneous Computing Model (2/7)}
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/MAarch2.PNG}
	\end{figure}
\end{frame}

\begin{frame}{Heterogeneous Computing Model (3/7)}
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/MAarch3.PNG}
	\end{figure}
\end{frame}

\begin{frame}{Heterogeneous Computing Model (4/7)}
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/MAarch4.PNG}
	\end{figure}
\end{frame}

\begin{frame}{Heterogeneous Computing Model (5/7)}
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/MAarch5.PNG}
	\end{figure}
\end{frame}

\begin{frame}{Heterogeneous Computing Model (6/7)}
	\begin{figure}
		\includegraphics[width=\linewidth]{figures/MAarch6.PNG}
	\end{figure}
\end{frame}

\begin{frame}{Heterogeneous Computing Model (7/7)}
	\begin{figure}
...
\begin{frame}{BVH Traversal Main Operations which Cause Divergence in Instruction Execution}
	\centering
	\scalebox{0.6}{
